...
function OnboardingInner() {
  ...
  function finishDiagnostic() {
    ...
    window.location.assign(studyStartUrl({ unit: form.schoolTopic || "u1" }));
  }
    ...
    <div className="max-w-2xl">
      ...
      <form
        ...
        onSubmit={(e) => {
          ...
          log("diagnostic_start", { schoolTopic: form.schoolTopic });
          setStep("diagnostic");
        }}
        action="#"
      >
        ...
        <fieldset className="rounded-lg border p-3">
          ...
          {!skipOptional && (
            <div className="mt-3 space-y-3">
              <Field label="Optional planning note (not a score prediction)">
                <Input
                  placeholder="e.g. I want more FRQ practice — this is a hope, not a predicted outcome"
